...
class TestCompareCoverageEdgeCases:
    ...
    def test_shows_removed_files(
        ...
        coverage_data = {
            ...
            "files": {
                "new/file.py": {"summary": {"percent_covered": 50.0, "covered_lines": 50, "num_statements": 100}}
            }
        }
        coverage_file = temp_project / "coverage.json"
        coverage_file.write_text(json.dumps(coverage_data))
    ...
    def test_shows_regressed_files(
        self, temp_project: Path, monkeypatch, capsys
    ):
        ...
        coverage_data = {
            ...
            "files": {
                "src/auth.py": {"summary": {"percent_covered": 50.0, "covered_lines": 50, "num_statements": 100}}
            }
        }
        coverage_file = temp_project / "coverage.json"
        coverage_file.write_text(json.dumps(coverage_data))
...
class TestUploadToArtifact:
    ...
    def test_shows_github_warning_when_not_in_actions(self, temp_project: Path, monkeypatch, capsys):
...
class TestGuardrailNotFound:
    ...
    def test_warns_when_guardrail_not_found(
        ...
        result = report_coverage(project_root=temp_project, guardrail_id=999)
...
class TestCompareWithManyChanges:
    ...
    def test_truncates_improved_files_list(
        self, temp_project: Path, monkeypatch, capsys
    ):
        ...
        coverage_data = {
            ...
            "files": {
                f"src/file{i}.py": {"summary": {"percent_covered": 95.0, "covered_lines": 95, "num_statements": 100}}
                for i in range(10)
            }
        }
        coverage_file = temp_project / "coverage.json"
    ...
    def test_truncates_regressed_files_list(
        self, temp_project: Path, monkeypatch, capsys
    ):
        ...
        coverage_data = {
            ...
            "files": {
                f"src/file{i}.py": {"summary": {"percent_covered": 50.0, "covered_lines": 50, "num_statements": 100}}
                for i in range(10)
            }
        }
        coverage_file = temp_project / "coverage.json"
    ...
    def test_truncates_new_files_list(
        self, temp_project: Path, monkeypatch, capsys
    ):
        ...
        coverage_data = {
            ...
            "files": {
                f"src/newfile{i}.py": {"summary": {"percent_covered": 70.0, "covered_lines": 70, "num_statements": 100}}
                for i in range(10)
            }
        }
        coverage_file = temp_project / "coverage.json"
    ...
    def test_truncates_removed_files_list(
        self, temp_project: Path, monkeypatch, capsys
    ):
...
class TestGenerateReportFileFormat:
    ...
    def test_file_without_summary_or_lines(self, temp_project: Path, monkeypatch):
        ...
        coverage_data = {
            ...
            "files": {
                "src/broken.py": {"no_summary": True, "no_lines": True}
            }
        }
        coverage_file = temp_project / "coverage.json"
        coverage_file.write_text(json.dumps(coverage_data))
