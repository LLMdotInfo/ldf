...
class TestGetDefaultConfig:
    ...
    def test_default_preset_is_custom(self):
        """Test that default preset is custom."""
        config = get_default_config()

        assert config["guardrails"]["preset"] == "custom"

    def test_has_default_question_packs(self):
        """Test that default config has question packs."""
        config = get_default_config()

        assert "security" in config["question_packs"]
        assert "testing" in config["question_packs"]
