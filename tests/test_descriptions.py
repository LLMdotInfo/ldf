...
class TestMcpServerInfo:
    ...
    def test_get_mcp_server_info_returns_dict(self):
        ...
        info = get_mcp_server_info("spec-inspector")
    ...
    def test_get_mcp_server_short(self):
        ...
        short = get_mcp_server_short("spec-inspector")
    ...
    def test_is_mcp_server_default(self):
        ...
        result = is_mcp_server_default("spec-inspector")
...
class TestFormatFunctions:
    ...
    def test_format_mcp_server_choice(self):
        ...
        formatted = format_mcp_server_choice("spec-inspector")

        assert isinstance(formatted, str)
        assert "spec-inspector" in formatted
        assert "-" in formatted
