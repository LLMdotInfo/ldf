...
```yaml
extends: "core"  # Always include core guardrails
preset: "saas"   # Add preset guardrails (optional)

# Override specific guardrails
overrides:
  testing_coverage:
    config:
      default_threshold: 85  # Increase from 80%

# Disable guardrails (with justification)
disabled:
  - id: 8
    reason: "Documentation handled separately"
