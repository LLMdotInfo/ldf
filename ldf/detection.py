...
class ProjectState(Enum):
    ...
    OUTDATED = "outdated"  # framework_version < installed version
    LEGACY = "legacy"  # Has .ldf/ but no framework_version in config
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "completeness": {
                ...
                "claude_commands": self.has_claude_commands,
            },
...
def detect_project_state(project_root: Path | None = None) -> DetectionResult:
        ...
        try:
            with open(ldf_dir / "config.yaml") as f:
                ...
                if config is None:
                    ...
                    config_valid = True
                    project_version = config.get("framework_version")
    ...
    return DetectionResult(
        ...
        has_claude_commands=has_claude_commands,
