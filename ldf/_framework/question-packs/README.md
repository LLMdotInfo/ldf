...
## Domain Question-Packs

Include based on your feature:

| Pack | Domain | When to Use |
|------|--------|-------------|
| `billing.yaml` | Payments, invoicing | Money flows |
| `multi-tenancy.yaml` | RLS, tenant isolation | SaaS apps |
| `provisioning.yaml` | Async jobs, queues | Background processing |
| `webhooks.yaml` | Inbox/outbox, signatures | Event-driven |
