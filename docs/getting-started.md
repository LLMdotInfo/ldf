...
**New to programming or command line?**
→ Start with [Installation Guides](installation/) - Complete step-by-step setup for your platform

**Familiar with terminal basics?**
→ Continue below for standard installation, or jump to [Your First Spec Tutorial](tutorials/01-first-spec.md)

**Experienced developer?**
→ Skip to [5-Minute Quickstart](quickstart.md) for rapid setup
...
|-------|-----------------|---------|
| `mcp` | `pip install llm-ldf[mcp]` | MCP servers for AI assistants (spec_inspector, coverage_reporter) |
| `automation` | `pip install llm-ldf[automation]` | API-based audits with ChatGPT or Gemini |
| `s3` | `pip install llm-ldf[s3]` | S3 coverage upload (`ldf coverage --upload s3://...`) |
...
To create and share templates, see [Template Workflow](customization.md#team-templates).
...
Install the [LDF VS Code extension](https://github.com/LLMdotInfo/ldf-vscode) for:
...
1. [Your First LDF Spec](tutorials/01-first-spec.md) - Create a simple "Hello World" spec (20 min)
2. [Understanding Guardrails](tutorials/02-guardrails.md) - Deep dive into the 8 core quality constraints (30 min)
3. [Working with Question-Packs](tutorials/03-question-packs.md) - Answer questions effectively (25 min)
4. [Multi-Agent Review Workflow](tutorials/04-multi-agent-review.md) - Get AI feedback on specs (30 min)
5. [MCP Setup for AI Assistants](tutorials/05-mcp-setup.md) - Integrate with Claude Code (20 min)
...
- [Workflow Diagrams](visual-guides/workflows.md) - ASCII diagrams of the 3-phase process
- [Guardrail Examples](visual-guides/guardrail-examples.md) - Real coverage matrices

### Reference

- [Command Reference](reference/commands.md) - Complete CLI command guide
